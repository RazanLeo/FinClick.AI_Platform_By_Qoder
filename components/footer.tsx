      ...
      content: `
        <div class="space-y-6 text-[#8B6914] text-right">
          ...
          <div class="space-y-2">
            ...
            <p>2. <strong>الاشتراك السنوي:</strong> قيمة الاشتراك السنوي ستون ألف (٦٠٬٠٠٠) ريال سعودي، مع خصم بنسبة ١٠٪ عند الدفع السنوي المسبق، ليصبح المبلغ الإجمالي أربعة وخمسون ألف (٥٤٬٠٠٠) ريال سعودي.</p>
          </div>
          ...
          <div class="space-y-2">
            ...
            <p>2. يمكن للمستخدم إلغاء التجديد التلقائي للاشتراك القادم بشرط تقديم إشعار كتابي قبل سبعة (٧) أيام على الأقل من تاريخ انتهاء الاشتراك الحالي.</p>
            <p>3. تتم حذف جميع بيانات الحساب نهائيًا بعد مرور ثلاثين (٣٠) يومًا من تاريخ إلغاء الاشتراك.</p>
          </div>
        </div>
      `,
    },
